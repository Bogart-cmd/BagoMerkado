                ...
                <div class="col-md-4">
                    <div class="breadcrumbs">
                        <a href="#">Home Page</a> <i class="fa fa-angle-right"></i> <a href="#">Product</a> <i
                            class="fa fa-angle-right"></i> Coffee
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-3">
                <div class="cart-box">
                    ...
                    <div class="row border-bottom pb-2 mb-2 mt-4">
                        ...
                        <div class="col-6 col-md-8 text-end">₱{{ number_format($total, 2) }}</div>
                    </div>
                    ...
                    <div class="row border-bottom pb-2 mb-2">
                        ...
                        <div class="col-6 col-md-8 text-end"><span>₱{{ number_format($finalTotal, 2) }}</span></div>
                    </div>
